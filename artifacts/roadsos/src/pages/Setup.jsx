      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-1 uppercase text-xs tracking-widest">
              Crucial data for emergency responders
            </p>
          </div>
        </motion.div>
        ...
        <Form {...form}>
          ...
          >
            ...
            >
              <h2 className="text-lg font-orbitron text-accent border-b border-white/10 pb-2 mb-4">
                PRIMARY BIOMETRICS
              </h2>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="pl-10 bg-background/50 border-white/10 text-white focus:border-accent"
                            {...field}
                          />
                        </div>
                      </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="resize-none bg-background/50 border-white/10 text-white focus:border-accent min-h-[80px]"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage className="text-primary text-xs" />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="E.g., Inhaler, Insulin, Blood thinners..."
                        className="resize-none bg-background/50 border-white/10 text-white focus:border-accent min-h-[80px]"
                        {...field}
                      />
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          placeholder="Provider name, Policy #"
                          className="pl-10 bg-background/50 border-white/10 text-white focus:border-accent"
                          {...field}
                        />
                      </div>
            ...
            >
              <div className="flex items-center justify-between border-b border-white/10 pb-2 mb-4">
                <h2 className="text-lg font-orbitron text-accent">
                  EMERGENCY CONTACTS
                </h2>
                <Button
                  type="button"
              ...
              <div className="space-y-4">
                {fields.map((field, index) => (
                  <div
                    key={field.id}
                    className="p-4 rounded-lg bg-background/30 border border-white/5 relative group"
                  >
                    {index > 0 && (
                      <Button
                        type="button"
