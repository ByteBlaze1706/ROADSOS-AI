      ...
      setMessages([
        {
          ...
          role: "assistant",
          content:
            "ROADSOS AI Agent online. State your emergency or request assistance.",
      ...
      <div className="p-4 bg-background border-t border-white/5">
        <form onSubmit={handleSend} className="flex gap-2">
          <Button
            ...
            size="icon"
            variant="outline"
            className="border-white/10 bg-black shrink-0"
          >
          ...
          <Button
            ...
            className="bg-accent hover:bg-accent/80 text-black shrink-0 neon-box-blue"
          >
