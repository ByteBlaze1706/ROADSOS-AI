...
import { Activity, AlertTriangle, Cpu, StopCircle, Radio } from "lucide-react";
...
export default function CrashDetection() {
  ...
  const simulateTimeoutRef = useRef();
      ...
      <AnimatePresence>
        {crashDetected && (
          ...
          >
            ...
            <h1 className="text-4xl font-orbitron font-bold text-white text-center tracking-wider mb-2">
              IMPACT DETECTED
            </h1>
      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <div className="glass-card p-8 flex flex-col items-center justify-center border-accent/20 flex-1 min-h-[300px] mb-6 relative overflow-hidden">
          ...
          <div className="text-center">
            <span className="text-sm text-accent uppercase tracking-widest mb-2 block font-bold">
              Current G-Force
            </span>
          ...
          <div className="absolute bottom-0 left-0 w-full h-24 flex items-end justify-center px-8 opacity-20">
            <div className="w-full h-[1px] bg-accent relative">
              <motion.div
                ...
                style={{
                  height: `${Math.min(gForce * 10, 100)}px`,
                  left: "50%",
