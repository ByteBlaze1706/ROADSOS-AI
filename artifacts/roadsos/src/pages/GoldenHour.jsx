...
import { Activity, ShieldAlert, Clock, ShieldCheck } from "lucide-react";
import {
    ...
    <div className="p-4 space-y-6 relative overflow-hidden min-h-screen">
        ...
        <div className="relative w-48 h-48 mt-4">
          <svg className="w-full h-full" viewBox="0 0 100 100">
            ...
            <motion.path
              ...
              strokeDasharray="200"
              strokeDashoffset={
                200 - (200 * (stats?.severityScore || 75)) / 100
              }
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="glass-card p-4 flex flex-col justify-between border-primary/20 bg-primary/5">
          ...
          <div className="text-3xl font-orbitron font-bold text-primary neon-text-red">
            {stats?.totalSosThisMonth || 3}
          </div>
        </div>
      </div>
      ...
      <div className="glass-card p-5">
        ...
        <Progress
          value={stats?.emergencyReadiness || 98}
          className="h-2 bg-white/10"
          indicatorClassName="bg-accent neon-box-blue"
        />
      ...
      <div className="bg-black/40 border-y border-accent/20 overflow-hidden h-8 flex items-center relative rounded-sm">
        ...
        <div className="bg-accent text-black text-[10px] font-bold px-2 py-1 uppercase tracking-widest h-full flex items-center z-20">
          LIVE
        </div>
        <motion.div
